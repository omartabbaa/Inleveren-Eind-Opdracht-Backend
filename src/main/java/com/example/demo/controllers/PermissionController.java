...
import com.example.demo.services.PermissionsService;
...
public class PermissionController {
    ...
    @PostMapping
    public ResponseEntity<PermissionsOutputDTO> createPermission(@RequestBody PermissionsInputDTO permissionsInputDTO) {
    ...
    public ResponseEntity<PermissionsOutputDTO> updatePermission(@PathVariable Long permissionId,
                                                                @RequestBody PermissionsInputDTO permissionsInputDTO) {
        try {
